...
const AboutHeader = () => {
  ...
  return (
    <section className="bg-white py-20 px-0 md:px-16" id="about">
      <div className="container mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        
        {/* Left Side - Image */}
        <div data-aos="fade-right">
          <img
            src="about.png" // <-- replace with your direct image URL or local path in /public
        ...
        <div data-aos="fade-left" className="text-left">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4" data-aos="fade-up" data-aos-delay="100">
              ...
              <div>
                <h3 className="text-xl font-semibold text-black">Natural Coffee Beans</h3>
            ...
            <div className="flex items-start gap-4" data-aos="fade-up" data-aos-delay="200">
              ...
              <div>
                <h3 className="text-xl font-semibold text-black">100% ISO Certification</h3>
                <p className="text-black text-base">
