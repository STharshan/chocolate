  ...
  return (
    <section className="py-16 px-4 bg-black">
      <div className="max-w-7xl mx-auto text-center">
        <h2 className="text-2xl md:text-3xl font-bold mb-10 text-[#a45731]">Find Us</h2>

        <div className="rounded-lg overflow-hidden shadow-lg w-full h-[400px] border-4 border-[#a45731]">
          <iframe
