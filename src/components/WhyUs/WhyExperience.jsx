      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h2 className="text-2xl font-semibold text-brown-700 mb-4">Master Chocolatiers</h2>
            <button className="text-sm text-[#346909] mb-4">Live Chocolate Making</button>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h2 className="text-2xl font-semibold text-brown-700 mb-4">Interactive Experience</h2>
            <button className="text-sm text-[#346909] mb-4">Watch & Learn</button>
            <div className="h-64 bg-gray-200 rounded-lg mb-4">
              {/* Image or video content */}
            </div>
            <p className="text-base text-gray-700">
